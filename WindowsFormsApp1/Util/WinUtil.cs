...
namespace FooflyProxy
{
    public class WinUtil
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "Foofly-proxy";
        ...
        public void SetMeAutoStart(bool onOff = true)
        {
            if (onOff)//开机启动
            {
                ...
                {
                    CreateShortcut(systemStartPath, QuickName, appAllPath, "Foofly Proxy");
                }
            }
            else//开机不启动
            {
        ...
        public void CreateDesktopQuick(string desktopPath = "", string quickName = "", string appPath = "")
        {
            ...
            {
                CreateShortcut(desktopPath, quickName, appPath, "Foofly Proxy");
            }
        }
    }
}
